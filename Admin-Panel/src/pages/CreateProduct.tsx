...
const CreateProduct = () => {
  ...
  const createMutation = useMutation({
    ...
    onError: (err: unknown) => {
      const msg = (err as any)?.response?.data?.error || "Gagal membuat produk";
      toast.error(msg);
    },
  });
  ...
  const handleSubmit = async () => {
    ...
    // Compress semua gambar sebelum kirim — cegah 413 Vercel
    ...
    <div className="min-h-screen flex dark:bg-[#0D0B14] bg-[var(--bg-2)]">
      ...
      <div className="flex-1 flex flex-col">
        <div className="page-header">
          <div>
            <h2 className="page-title">Tambah Produk</h2>
            <p className="page-subtitle">Isi informasi produk baru</p>
          </div>
            ...
            <div className="card p-6">
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <input className="input-base" type="text" placeholder="Gamis Syar'i Premium..." value={form.name}
                ...
                <div>
                  ...
                  <input className="input-base" type="text" placeholder="gamis-syari-premium" value={form.slug}
            ...
            <div className="card p-6">
              ...
              <div className="space-y-3">
                <label className="flex items-center gap-3 cursor-pointer">
                  ...
                  <span className="text-sm text-[var(--text)]">Tampilkan di Pilihan Terbaik (Featured)</span>
                </label>
                <label className="flex items-center gap-3 cursor-pointer">
