...
async function main() {
  console.log("🌱 Seeding Supabase PostgreSQL lumara-id...");
  ...
  // ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
  // PRODUCTS — PostgreSQL: arrays & Json native (no JSON.stringify)
  // ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
  const productData = [
    {
      ...
      images: ["https://images.unsplash.com/photo-1614091050040-57e14d8f8aea?w=600", "https://images.unsplash.com/photo-1583391733956-6c78276477e2?w=600"],
      stock: 45,
      categoryId: gamis.id,
      sizes: ["S", "M", "L", "XL", "XXL"],
      colors: ["Dusty Pink", "Sage Green", "Navy", "Cream"],
      rating: 4.9,
      reviewCount: 186,
      isFeatured: true,
      isNew: false,
    ...
    },
    {
      ...
      images: ["https://images.unsplash.com/photo-1603039882975-d8ab98ace8c0?w=600"],
      stock: 150,
      categoryId: hijab.id,
      sizes: ["Freesize"],
      colors: ["Dusty Pink", "Sage", "Navy", "Black", "White", "Maroon", "Cream", "Olive"],
      rating: 4.8,
      reviewCount: 524,
      isFeatured: true,
      isNew: false,
    },
    {
      ...
      categoryId: hijab.id,
      sizes: ["Freesize"],
      colors: ["Dusty Pink", "Sage", "Cream", "Maroon"],
      rating: 4.6,
      reviewCount: 89,
      isFeatured: false,
      isNew: true,
    ...
    },
    {
      ...
      images: ["https://images.unsplash.com/photo-1614091050040-57e14d8f8aea?w=600"],
      stock: 15,
      categoryId: gamis.id,
      sizes: ["S", "M", "L", "XL"],
      colors: ["Maroon", "Navy", "Sage"],
      rating: 4.8,
      reviewCount: 128,
      isFeatured: true,
      isNew: false,
  ...
  if (ameena) {
    const existing = await prisma.review.findFirst({ where: { userId: customer.id, productId: ameena.id } });
    if (!existing) {
