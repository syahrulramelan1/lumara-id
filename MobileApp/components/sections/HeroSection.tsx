    ...
    <section className="relative overflow-hidden bg-gradient-to-br from-[#F9F9FF] via-[#EDE9FE] to-[#F0E6FF] dark:from-[#111113] dark:via-[#111113] dark:to-[#111113] min-h-[480px] flex items-center">
      ...
      <div className="relative max-w-7xl mx-auto px-4 py-16 md:py-24 w-full">
        <div className="max-w-2xl">
          ...
          {/* Marquee trust-badge di bawah search — lebar mengikuti max-w-md search */}
          <motion.div
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
            transition={{ duration: 0.5, delay: STAGGER_DELAY * 5 }}
            className="mt-5 max-w-md overflow-hidden rounded-xl border border-primary/20 bg-white/70 dark:bg-white/10 backdrop-blur-sm shadow-sm dark:shadow-white/5"
          >
